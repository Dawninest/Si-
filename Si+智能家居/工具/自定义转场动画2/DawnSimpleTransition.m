...
@implementation DawnSimpleTransition
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    if(!self.isReverse){
        ...
        [UIView transitionWithView:animatedViewForTransition duration:[self transitionDuration:transitionContext] * .7 options:0 animations:^{
        ...
        [UIView animateWithDuration:[self transitionDuration:transitionContext] * .42 delay:[self transitionDuration:transitionContext] * .58 options:0 animations:^{
        ...
        [UIView animateWithDuration:[self transitionDuration:transitionContext] * .7 animations:^{
        ...
        [UIView transitionWithView:animatedViewForTransition duration:[self transitionDuration:transitionContext] * .58 options:0 animations:^{
